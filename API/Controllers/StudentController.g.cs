...
namespace SchoolManagementTest.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the StudentController class with the specified context.
        /// </summary>
        /// <param name="istudentservice">The istudentservice to be used by the controller.</param>
        ...
        {
            var id = _studentService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _studentService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var status = _studentService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Student updatedEntity)
        {
            ...
            var status = _studentService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Student> updatedEntity)
        {
            ...
            var status = _studentService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}