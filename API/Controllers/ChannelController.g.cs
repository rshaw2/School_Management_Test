...
{
    /// <summary>
    /// Controller responsible for managing channel related operations.
    /// </summary>
    /// <remarks>
    ...
    public class ChannelController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ChannelController class with the specified context.
        /// </summary>
        /// <param name="ichannelservice">The ichannelservice to be used by the controller.</param>
        public ChannelController(IChannelService ichannelservice)
        {
            _channelService = ichannelservice;
        }
        ...
        {
            var id = _channelService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _channelService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var status = _channelService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Channel updatedEntity)
        {
            ...
            var status = _channelService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Channel> updatedEntity)
        {
            ...
            var status = _channelService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}