...
{
    /// <summary>
    /// Controller responsible for managing absencetype related operations.
    /// </summary>
    /// <remarks>
    ...
    public class AbsenceTypeController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AbsenceTypeController class with the specified context.
        /// </summary>
        /// <param name="iabsencetypeservice">The iabsencetypeservice to be used by the controller.</param>
        public AbsenceTypeController(IAbsenceTypeService iabsencetypeservice)
        {
            _absenceTypeService = iabsencetypeservice;
        }
        ...
        {
            var id = _absenceTypeService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _absenceTypeService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var result = _absenceTypeService.GetById(id);
            return Ok(result);
        }
        ...
        {
            var status = _absenceTypeService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] AbsenceType updatedEntity)
        {
            ...
            var status = _absenceTypeService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<AbsenceType> updatedEntity)
        {
            ...
            var status = _absenceTypeService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}