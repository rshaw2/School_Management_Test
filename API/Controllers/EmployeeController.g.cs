...
namespace SchoolManagementTest.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the EmployeeController class with the specified context.
        /// </summary>
        /// <param name="iemployeeservice">The iemployeeservice to be used by the controller.</param>
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _employeeService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Employee updatedEntity)
        {
            ...
            var status = _employeeService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Employee> updatedEntity)
        {
            ...
            var status = _employeeService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}